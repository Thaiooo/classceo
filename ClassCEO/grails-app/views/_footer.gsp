								...
								<div class="6u">
									...
									<section>
										...
										<div class="row">
											<div class="6u">
												<ul class="style3">
													<li class="first"><a href="#" class="contact-icon contact-icon-email">info@classceo.fr</a></li>
													<li class="link nopad">
														<a href="#" class="contact-icon contact-icon-address"><span>14 Rue Charles V<br />
														75004 Paris</span>				
													</a></li>
												</ul>
											</div>
